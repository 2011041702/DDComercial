package com.example.chris.ddcomercial.Clases;
...
public class Conexion {
    ...
    public static final String _IMG_MARCA = "imagen";

    public static final String ID_PROD = "id";
    public static final String NOMBRE_PROD = "nombre";
    public static final String PRECIO_PROD = "precio";
    public static final String IMAGE_PROD = "imagen";
